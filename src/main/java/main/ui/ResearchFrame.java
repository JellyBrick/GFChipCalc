...
//                System.out.println(task);
                if (task == null || task.isEmpty()) {
                    ...
                    int boardStar = Integer.parseInt(split[1]);
                    if (split.length == 2) {
                        ...
                        for (String s : shapeStrs.split(",")) {
                            shapes.add(Shape.byId(Integer.parseInt(s)));
                        }
    ...
    private void updateProgress() {
        ...
        if (progress == null || progress.isEmpty()) {
            ...
            int prog = Integer.parseInt(split[0]);
    ...
    private void start() {
        ...
        for (int i = 0; i < (int) aSpinner.getValue(); i++) {
            tasks.add(ThreadPoolManager.getThreadPool().submit(aRunnable));
        }
