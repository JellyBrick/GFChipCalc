...
public class HelpDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        chipButton.addActionListener(this::chipButtonActionPerformed);

        appButton.setText("칩셋 조합기 가이드");
        appButton.addActionListener(this::appButtonActionPerformed);
        ...
        changelogButton.addActionListener(this::changelogButtonActionPerformed);
