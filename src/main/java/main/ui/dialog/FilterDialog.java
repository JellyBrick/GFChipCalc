...
public class FilterDialog extends JDialog {
    ...
    private void fixPtMinSpinners() {
        for (int i = 0; i < ptMinSpinners.length; i++) {
            ...
            if ((int) ptMinSpinner.getValue() > (int) ptMaxSpinner.getValue()) {
                ptMinSpinner.setValue(ptMaxSpinner.getValue());
            }
        }
    }
    ...
    private void fixPtMaxSpinners() {
        for (int i = 0; i < ptMaxSpinners.length; i++) {
            ...
            JSpinner ptMaxSpinner = ptMaxSpinners[i];
            if ((int) ptMinSpinner.getValue() > (int) ptMaxSpinner.getValue()) {
                ptMaxSpinner.setValue(ptMinSpinner.getValue());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        starPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, star2TB, star3TB, star4TB, star5TB);
        ...
        starPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, star2TB, star3TB, star4TB, star5TB);
        ...
        colorPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, colorBlueTB, colorOrangeTB);
        ...
        colorPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, colorBlueTB, colorOrangeTB);
        ...
        cellPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, size1TB, size2TB, size3TB, size4TB, size6TB);
        ...
        cellPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, size1TB, size2TB, size3TB, size4TB, size5ATB, size5BTB, size6TB);
        ...
        tagResetButton.addActionListener(this::tagResetButtonActionPerformed);
        ...
        presetButton.addActionListener(this::presetButtonActionPerformed);
