...
public class ImageDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        addToggleButton.addActionListener(this::addToggleButtonActionPerformed);

        deleteToggleButton.setText("삭제");
        deleteToggleButton.setFocusable(false);
        deleteToggleButton.addActionListener(this::deleteToggleButtonActionPerformed);
