...
public class CalcSettingDialog extends JDialog {
    ...
    private void maxSpinnerEvent() {
        if (!radioLoading) {
            ...
            if (maxPtRadioButton.isSelected()) {
                ptSumLabel.setText(app.getText(AppText.UNIT_PT, pt.sum() + "/" + total));
            } else {
    ...
    private void initComponents() {
        ...
        maxPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, brkTextLabel, dmgTextLabel, hitTextLabel, rldTextLabel);
        ...
        markTypeButton.addActionListener(this::markTypeButtonActionPerformed);
        ...
        advancedButton.addActionListener(this::advancedButtonActionPerformed);
