            ...
            if (v.isCurrent(4, 2, 0)) {
                generalLines.forEach((line) -> {
                    ...
                    // Board
                        ...
                        boardSortType = Integer.parseInt(afterEqual(line));
                    }//
                    // Combinator
                ...
                fontSize = Integer.parseInt(generalLines.get(1));

                poolOrder = IO.parseBoolean(generalLines.get(2));
                poolStar = 5 - Integer.parseInt(generalLines.get(3));
                poolColor = Integer.parseInt(generalLines.get(4));

                poolPanelVisible = IO.parseBoolean(generalLines.get(5));
                displayType = Integer.parseInt(generalLines.get(6));
                ...
                colorPreset = Integer.parseInt(generalLines.get(11));
            }
